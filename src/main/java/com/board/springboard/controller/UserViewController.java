...
/*  사용 X ->로그인을 통해 세션관리를 진행하기 위해 만들어진 Mapping

로그인이라는 작업을 하면 쿠키에 유효기간이 설정된 인증팔찌를 이용할 것이기 때문에 사용 X
    ...
    public String profileView(@AuthenticationPrincipal String email, Model model, UserDetails authenticatedPrincipal) {
