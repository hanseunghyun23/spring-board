...
*                                   필요시 SQL과 연경된 mapper 활용하여 서비스 로직 작성
* 5.controller.java                 어떤 api.endpoint 주소에서 어떤 jsp or html 템플릿을 보여줄 것인지
*                                    주소에서 템플릿을 보여줄 때 가져갈 데이터나 특성 설정이 있다면
 *                                   서비스에서 기능을 가져와 로직 세팅
 * 6.jsp파일                                   유저에서 보여줄 화면 세팅
 *
* */
