...
uri http://java.sun.com/jsp/jstl/core을(를) 가진 taglib를 해결할 수 없습니다
 ...
 //maven.com 에 나와있는 gradle 모듈 주소 작성
    implementation 'org.apache.tomcat.embed:tomcat-embed-jasper'
    ->jsp확장자 사용할 수 있는 모듈 세팅
    implementation 'jakarta.servlet.jsp.jstl:jakarta.servlet.jsp.jstl-api'
    -> c:if c:forEach 문법들을 사용해야하는 문법 규칙 정의서
    implementation 'org.glassfish.web:jakarta.servlet.jsp.jstl'
->문법 정의서에 작성되어 있는 기능명칭들의 실질적인 기능 코드들이 담겨있다

www.maven.com 에서 pom.xml 형식이나 gradle 형식을 복붙할 수 있다
AI에게 도움을 요청해서 필요한 모듈에 대하여 전달받을 수 있다
 --%>
<!DOCTYPE html>
<html lang="ko">
<head>
