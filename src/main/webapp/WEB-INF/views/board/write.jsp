...
<div class="container mt-5" style="max-width: 600px;"><!--여기서부터 페이지 전체 꾸미기 시작 아래와 여백을 5 정도 두겠다 -->
    <div class="card p-4 shadow-sm"><!--게시물 작성을 하나의 카드로 보겠다 padding 내부 여백은 4단계 카드들의 그림자효과 -->
        <h2 class="mb-4">새 게시물 작성</h2>
<!-- 새 게시물 작성이라는 개발자가 지정한 제목과 클라이언트가 작성해야하는 공간과 4단계정도 간격을 둘 것이다-->
        <form action="/board/write" method="post" enctype="multipart/form-data">
            <div class="mb-3"><!-- 제목 틀과 작성자 틀의 간격을 3단계정도 두겠다.-->
                <label class="form-label">제목</label><!--input에 어떤 데이터를 작성해야 하는지 설문-라벨 디자인 설정 -->
            ...
            <div class="mb-3"><!-- 내용 틀과 작성자 틀의 간격을 3단계정도 두겠다.-->
                <label class="form-label">내용</label>
                <textarea name="content" class="form-control" rows="10" required></textarea>
            </div>
            <div class="mb-3">
                <label class="form-label">
                    이미지 첨부 <span class="text-muted">(최대 5장)</span><!-- 음소거 죽이다. 설명첢 희미하게-->
                </label>
                <input type="file" name="imageFiles" accept="image/*" multiple
                       class="form-control" onchange="미리보기기능(this)">
                <div id="이미지개수" class="small ,  mt-1"></div><!--크기를 작게 글씨 색상을 죽여서 미리보기 기능과 1단계정도 간격을 주겠다-->
            </div>
...
<!--d-flex display:flex div 내에 존재하는 태그들을 가로로 나란히 배치
    flex-wrap :태그가 너무 많아져서 한 줄에 들어오기 어려울 경우 자동으로 다음줄에 배치하겠다
...
<script>
    function 미리보기기능(input) {
        ...
        if (파일들.length > 5) {
            ...
            //이미지개수.style.setProperty("color","red", "important");
            //이미지개수.style.color = "red !important";
