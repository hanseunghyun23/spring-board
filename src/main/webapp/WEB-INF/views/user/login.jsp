...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js"
    ...
    async function 로그인() {
        ...
        const 이메일 = document.getElementById("${users.id}").value;

        // TODO 5-2 : id="에러창", id="loginBtn" 인 요소를 변수에 담으세요.
        const 에러창   = document.getElementById("${param}");
        const 로그인버튼 = document.getElementById("____");
        ...
        try {
            ...
            에러창.innerHTML = `<div class="alert alert-danger mt-2">____</div>`;

        } finally {
            // TODO 5-10 : finally 에서 버튼을 다시 활성화하고 텍스트를 "로그인" 으로 복구하세요.
            로그인버튼.disabled = ;
            로그인버튼.textContent = "로그인";<%@ page contentType="text/html;charset=UTF-8" %>
            <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            <!DOCTYPE html>
            <html lang="ko">
                <head>
    ...
    <script>
        ...
        const password = document.getElementById("password").value.trim()
                ...
                alert("이메일과 비밀번호를 입력하세요")
                    return;
                //return 안쓰면 이메일과 비밀번호를 입력하세요. 를 보여주고 로그인를 시켜주는 꼴이 됨
                }
